...
def get_block_indices(_img,  block_id=None, block_size=(50,50,5), stride=(10,10,5)):
    h,w,d = _img.shape
    ...
    if block_id == None:
        ...
        block_index_X = ( block_id // len(blocks_h) ) % len(blocks_w)
        block_index_Z = block_id // (len(blocks_h) *  len(blocks_w)) 
        ...
        # print (f"{block_h_start}:{block_h_end}, {block_w_start}:{block_w_end}, {block_d_start}:{block_d_end}")
        # return f"{block_h_start}:{block_h_end}, {block_w_start}:{block_w_end}, {block_d_start}:{block_d_end}"

        return block_h_start,block_h_end, block_w_start,block_w_end, block_d_start,block_d_end

def getblock(_img,  block_id=None, block_size=(50,50,5), stride=(10,10,5)):
        block_h_start,block_h_end, block_w_start,block_w_end, block_d_start,block_d_end = get_block_indices(_img=_img, block_id=block_id, block_size=block_size, stride=stride)
